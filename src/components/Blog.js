      ...
      return (
        ...
        <Card className='card' shadow={5} style={{minWidth:'400', mergin: 'auto'}}>
          ...
          <CardText>
            ...
            <a href="https://medium.com/@tanuka.das12/optimization-of-linkedin-profile-for-new-developers-203a566be95" target='_blank' rel="noopener noreferrer">more</a>
          </CardText>
          <CardActions className="blog-buttons" style={{textAlign:'center'}} border>
...
" target='_blank' raised>Medium</Button>
        ...
        <Card className='card' shadow={5} style={{minWidth:'400', mergin: 'auto'}}>
          ...
          <CardText>
            ...
            <a href="https://medium.com/@tanuka.das12/react-js-manage-states-87830a369f0" target='_blank' rel="noopener noreferrer">more</a>
          </CardText>
          <CardActions className="blog-buttons" style={{textAlign:'center'}} border>
        ...
        <Card className='card' shadow={5} style={{minWidth:'400', mergin: 'auto'}}>
          ...
          <CardText>
            ...
            <a href="https://medium.com/@tanuka.das12/components-architecture-734cca8bc3ab" target='_blank' rel="noopener noreferrer">more</a>
          </CardText>
          <CardActions className="blog-buttons" style={{textAlign:'center'}} border>
        ...
        <Card className='card' shadow={5} style={{minWidth:'400', mergin: 'auto'}}>
          ...
          <CardText>
            ...
            <a href="https://medium.com/@tanuka.das12/rails-flash-hash-23a7126e20ab" target='_blank' rel="noopener noreferrer">more</a>
          </CardText>
          <CardActions className="blog-buttons" style={{textAlign:'center'}} border>
        ...
        <Card className='card' shadow={5} style={{minWidth:'400', mergin: 'auto'}}>
          ...
          <CardText>
            ...
            <a href="https://medium.com/@tanuka.das12/rails-api-from-scratch-1e109cd2580d" target='_blank' rel="noopener noreferrer">more</a>
          </CardText>
          <CardActions className="blog-buttons" style={{textAlign:'center'}} border>
        ...
        <Card className='card' shadow={5} style={{minWidth:'400', mergin: 'auto'}}>
          ...
          <CardText>
            ...
            <a href="https://medium.com/@tanuka.das12/set-up-rails-model-ba36db24bd76" target='_blank' rel="noopener noreferrer">more</a>
          </CardText>
          <CardActions className="blog-buttons" style={{textAlign:'center'}} border>
        ...
        <Card className='card' shadow={5} style={{minWidth:'400', mergin: 'auto'}}>
          ...
          <CardText>
            ...
            <a href="https://medium.com/@tanuka.das12/set-up-rails-controller-bd701198a4f1" target='_blank' rel="noopener noreferrer">more</a>
          </CardText>
          <CardActions className="blog-buttons" style={{textAlign:'center'}} border>
