          ...
          <Cell col={12}>
            ...
            /*src= "https://freepngimg.com/thumb/wonder_woman/20973-1-wonder-woman-picture.png"*/
              ...
              <div className="intro-text" style={{marginTop: '30px'}}>
                ...
                <p style = {{ margin: "2em"}}>Interest: full-time, apprentship, internship</p>
                <br/>

                <Button className="btn-download" href="TanukaDas_Resume.pdf" target="_blank" download="Tanuka's resume"><i class="fa fa-download"></i>

                  Download Resume

                </Button>

                <Button className="btn-download" href="mailto: tanuka.das12@gmail.com" rel="noopener noreferrer">
